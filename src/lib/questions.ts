...
export const questions: Question[] = [
  ...
  {"id": "q13", "text": "Are there external factors affecting your business? If applicable then could you please share brief details about the impact of external factors", "section": "Strategy & Market Priorities", "type": "text", "required": false},
  {"id": "q14", "text": "What is your customer retention strategy?", "section": "Strategy & Market Priorities", "type": "text", "required": true},
  {"id": "q15", "text": "What are your top 3 business priorities for the next 12 months?", "section": "Strategy & Market Priorities", "type": "text", "required": true},
  {"id": "q16", "text": "Which areas of your business need immediate attention?", "section": "Strategy & Market Priorities", "type": "text", "required": true},
  {"id": "q17", "text": "What outcomes would you like to achieve in these areas?", "section": "Strategy & Market Priorities", "type": "text", "required": true},
  {"id": "q18", "text": "Do you currently have all the resources you need to execute your strategy over the next 12 months?", "section": "Constraints & Resources", "type": "text", "required": true},
  {"id": "q19", "text": "How would you define success for your business?", "section": "Measurement & Success", "type": "text", "required": true},
  {"id": "q20", "text": "What is your core business metric for the next 12 months?", "section": "Measurement & Success", "type": "text", "required": true},
  {"id": "q21", "text": "What measurable outcomes will indicate success?", "section": "Measurement & Success", "type": "text", "required": true},
  {"id": "q22", "text": "Which key metrics are you currently tracking, and what are their latest values and timeframes?", "section": "Measurement & Success", "type": "text", "required": true}
];
